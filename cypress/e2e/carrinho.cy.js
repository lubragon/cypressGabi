describe('Testes de usabilidade do carrinho', ()=>
{
    beforeEach(()=>
        ...
        it('Deve tentar adicionar itens ao carrinho extrapolando o limite de compra e falhar', () => 
        {
            ...
            cy.get(':nth-child(1) > .thumbnail > .pricetag > .nostock')
                .should('have.text', 'Out of Stock')
            cy.get('[title="Designer Men Casual Formal Double Cuffs Grandad Band Collar Shirt Elegant Tie"]')
                .click();
            ...
            cy.contains('Allowed product\'s quantity exceeds. Quantity was set to maximum.')
                .should('be.visible')
        })
